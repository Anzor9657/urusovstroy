  ...
  <div class="main">
    ...
    <div class="padding-100">
      ...
      <div class="top-title-container">
        <span class="top-title">Строительство домов <br />под ключ</span>
      </div>
      <div class="feedback">
    ...
    <b-row align-h="center" class="padding-100">
      ...
      <b-col cols="6" class="title-text">
        Наша компания производит полный цикл работ, связанных со строительством
        домов в Нальчике. С нашей помощью вы станете счастливым собственником
        частного дома, который простоит несколько веков.
        <b-row class="mt-4">
          <b-col class="small-text text-gray">
            Проект может быть реализован как за меньшую сумму, так и за большую.
            Нужно заранее понимать свой бюджет, определить его для нас и мы
            сделаем проект, комплектацию так, чтобы этих денег хватило
          </b-col>
          <b-col class="small-text text-gray">
            Свои специалисты для каждого из этапов работ. От дизайна и проекта
            до строительства и отделки. Строим строго с соблюдением СНИП и ГОСТ.
            Гарантия на долгие годы, благодаря комплексному подходу.
          </b-col>
        </b-row>
      </b-col>
    </b-row>
      ...
      <b-col cols="6" offset="1">
        <b-row class="padding-100">
          ...
          <b-col cols="5" class="mr-auto">
            ...
            <div class="small-text padding-50">
              Соберем все необходимые документы и зарегестрируем в МФЦ. Подберем
              бригаду и начнем строить
            </div>
          </b-col>
