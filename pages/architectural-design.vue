    ...
    <div v-show="rollingTop">
      ...
      <b-container fluid class="margin-all-100 back-img">
        ...
        <b-row align-h="center">
          ...
          <span class="top-title-text">проект дома<br />европейского уровня</span>
        </div>
          </b-col>
      ...
      <b-row  align-h="center" class="padding-150">
        ...
        <b-col cols="3" class="font-weight-bold">Проектирование</b-col>
      </b-row>
...
.main {
  ...
  overflow: hidden;
  .back-img {
    background: url(../static/images/architecturial-design/title-img.png);
